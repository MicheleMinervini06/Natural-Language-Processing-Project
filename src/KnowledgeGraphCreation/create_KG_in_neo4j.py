...
if __name__ == "__main__":
    ...
    print("3. Dati grezzi generati con KGGen")
    print("4. Dati GREZZI generati con GRAPHRAG E GEMINI")

    choice = input("Inserisci 1, 2, 3 o 4: ").strip()
    ...
    if choice == "1":
        ...
        entities_file = "kg_entities_raw_empulia_kggen.json"
        relations_file = "kg_relations_raw_empulia_kggen.json"
        use_raw_data = True
        NEO4J_DATABASE = "testkggen"
        print("Caricamento dati grezzi generati con KGGen...")   
    elif choice == "4":
        entities_file = "kg_entities_raw_empulia_gemini_v2_async.json"
        relations_file = "kg_relations_raw_empulia_gemini_v2_async.json"
        use_raw_data = True
        NEO4J_DATABASE = "testgraphrag"
        print("Caricamento dati grezzi generati con GRAPHRAG E GEMINI...") 
    else:
